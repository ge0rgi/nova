...
class TrustAssertionFilter(filters.BaseHostFilter):
    ...
    def host_passes(self, host_state, spec_obj):
        ...
        LOG.debug(spec_obj.image.properties.get('mtwilson_trustpolicy_location'))
        ...
        if trust_verify == 'true':
            ...
            tag_selections = image_props.get('asset_tags')  # comma seperated values
        ...
        host_data = self.attestservice.do_attestation(host_state.nodename)
